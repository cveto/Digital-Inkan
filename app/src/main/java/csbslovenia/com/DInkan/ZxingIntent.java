 ...
 * @author gcstang
 */
public class ZxingIntent {
  // CUSTOMIZED CODE by Florjan
  public String WHILE_SCANNING_MESSAGE = "Skeniram";  //not static because Japanese support?
  //

    // FLO EDITED THIS BECAUSE...
  //public static final int REQUEST_CODE = 0x0000c0de; // Only use bottom 16 bits
    public static int REQUEST_CODE = 0x0000c0de; // Only use bottom 16 bits


    private static final String TAG = ZxingIntent.class.getSimpleName();
   ...
   */
  public ZxingIntent(Activity activity) {
   ...
   */
  public ZxingIntent(Fragment fragment) {
  ...
  public final AlertDialog initiateScan(Collection<String> desiredBarcodeFormats, int cameraId) {
    ...
    attachMoreExtras(intentScan);
      ...
      //FLORJAN ADDED CODE -
      intentScan.putExtra("PROMPT_MESSAGE", WHILE_SCANNING_MESSAGE);
   ...
   *  else an {@link ZxingResult} containing the result of the scan. If the user cancelled scanning,
   *  the fields will be null.
   */
  public static ZxingResult parseActivityResult(int requestCode, int resultCode, Intent intent) {
    if (requestCode == REQUEST_CODE) {
      if (resultCode == Activity.RESULT_OK) {
        ...
        return new ZxingResult(contents,
                                formatName,
                                rawBytes,
                                orientation,
  ...
  // FLO ADDED CODE - so i can add a message under the barcode. Probably could be done easer now.
  public void setScanningMessage(String message) {
        WHILE_SCANNING_MESSAGE = message;
    }

  // FLO ADDED CODE - because I needed the request codes... scanning multiple qr codes one after another.
  public void setRequestCode(int requestCode) {
        // had to remove the Final for this
